...
## Partial / In Progress 🔄
- 🔄 **Order tracking page:** `/order-tracking` UI exists but not wired to backend order lookup
- 🔄 **Admin: inventory management:** Low-stock alerts and bulk stock updates not in admin UI yet
- 🔄 **Admin: product CRUD:** Schema and some handlers exist; full create/edit/archive flow in admin UI completeness unknown
- 🔄 **Admin: customer management:** Page exists in sidebar nav, functionality extent unknown
- 🔄 **Admin: marketing/promotions:** Page exists; discount code UI CRUD completeness unknown
- 🔄 **Admin: shipping management:** Shipping zones schema exists; admin shipping configuration UI extent unknown
...
## Recently Completed (Sprint 1 — 2026-03-10)
...
- ⬜ **Tracking number:** Admin can manually enter tracking; tracking page/link not built
...
2. **Sprint 2 — Inventory & Orders:** Admin inventory management UI, tracking number flow, order tracking page
