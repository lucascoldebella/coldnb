...
export const metadata = {
  title:
    "Product Detail Description fullwidth || ColdnbMain - Multipurpose React Nextjs eCommerce Template",
  description: "ColdnbMain - Multipurpose React Nextjs eCommerce Template",
};
